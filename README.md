...
<div style="text-align:center"><img src="https://media.forgecdn.net/attachments/description/null/description_b4d8c824-d8b5-4d12-92bc-d34c437afbdc.png" width="30%"> <img src="https://media.forgecdn.net/attachments/description/null/description_dc53f1cb-c987-4740-b54a-b344dffc53cc.png" width="30%"> <img src="https://media.forgecdn.net/attachments/description/null/description_b6c5f523-f277-43df-b2d4-b041f5f81f08.png" width="30%"></div>
...
Hex items can be crafted at the arcane and alchemy bench.

### ✧ Evoke Book

A simple way to bring Hex Creatures to life, just use Evoke Book on a hex object.

### ✧ Hexcode Gliph

Combine the glyphs projectile → area → evoke to create an area of effect. Evoke can be created by combining square + triangle + diamond. For more information about the Hexcode system, visit: [https://www.curseforge.com/hytale/mods/hexcode](https://www.curseforge.com/hytale/mods/hexcode)