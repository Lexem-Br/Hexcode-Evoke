...
import com.lexem.hexcodeevoke.npc.sensors.SensorSearchChestTaskPosition;

import javax.annotation.Nonnull;

public class BuilderSensorSearchChestTaskPosition extends BuilderSensorBase {
    ...
    public BuilderSensorSearchChestTaskPosition() {
    }

    @Nonnull
    @Override
    public String getShortDescription() {
        return "Search for a chest on task list";
    }
    ...
    public Sensor build(@Nonnull BuilderSupport builderSupport) {
        return new SensorSearchChestTaskPosition(this, builderSupport);
    }
