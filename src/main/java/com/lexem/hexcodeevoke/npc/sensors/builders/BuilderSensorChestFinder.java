...
import com.lexem.hexcodeevoke.npc.sensors.SensorChestFinder;

import javax.annotation.Nonnull;

public class BuilderSensorChestFinder extends BuilderSensorBase {
    ...
    public BuilderSensorChestFinder() {
    }

    @Nonnull
    @Override
    public String getShortDescription() {
        return "Search for a chest that has available slots.";
    }
    ...
    public Sensor build(@Nonnull BuilderSupport builderSupport) {
        return new SensorChestFinder(this, builderSupport);
    }
