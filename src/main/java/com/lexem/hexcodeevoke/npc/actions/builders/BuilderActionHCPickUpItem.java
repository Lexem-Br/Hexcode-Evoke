...
import com.lexem.hexcodeevoke.npc.actions.ActionHCPickUpItem;

import javax.annotation.Nonnull;
import java.util.EnumSet;

public class BuilderActionHCPickUpItem extends BuilderActionWithDelay {
   ...
   public BuilderActionHCPickUpItem() {
   }
   ...
   public Action build(@Nonnull BuilderSupport builderSupport) {
      return new ActionHCPickUpItem(this, builderSupport);
   }

   @Nonnull
   public BuilderActionHCPickUpItem readConfig(@Nonnull JsonElement data) {
      this.getDouble(
